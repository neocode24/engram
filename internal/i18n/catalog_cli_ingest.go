...
--related <슬러그>를 반복해 이 자리에서 채울 수 있습니다.`,
		...
		"cli.promote.flag_related":         "related 필드에 추가할 슬러그. 여러 번 쓸 수 있습니다",
...
본문은 upstream promotion-rules.md가 요구하는 절 제목의 골격만 넣습니다.`,
		...
		"cli.new.flag_related": "관련 문서 슬러그. 여러 번 쓸 수 있습니다",
...
short, repeat --related <slug> to fill them in here.`,
		...
		"cli.promote.flag_related":         "Slug to add to the related field. Can be repeated",
...
The body gets only the skeleton of the section titles that upstream promotion-rules.md requires.`,
		...
		"cli.new.flag_related": "Related document slugs. Can be repeated",
