...
무엇도 바꾸지 않습니다. 규칙은 읽는 것입니다.`,
		...
		"cli.rules.gate_condition":     "문서의 고유 위키링크 수가 min_wikilinks %d개에 못 미치는 것입니다.",
...
Changes nothing. Rules are for reading.`,
		...
		"cli.rules.gate_condition":     "The document's unique wikilink count falls short of min_wikilinks %d.",
