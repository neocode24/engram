...
| [0011](0011-repo-layout-and-module-name.md) | 저장소 구성과 Go 모듈명 | 2026-08-14 | accepted |
...
| 0004 | 내부 미러를 배포 경로로 쓴다 | [0012](0012-distribution-via-personal-homebrew-tap.md) 사내 자료 격리 용도로 재정의 |
